  ...
  const loadPreviousSubmission = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://lms-server-1-v648.onrender.com/courses/answers/previous-submission?courseId=${courseId}&exerciseId=${exerciseId}&questionId=${question._id}&category=${category}`,
        {
          headers: {
