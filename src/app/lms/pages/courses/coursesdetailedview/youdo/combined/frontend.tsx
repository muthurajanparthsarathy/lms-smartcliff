  ...
  const loadPreviousSubmission = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://lms-server-3-wedg.onrender.com/courses/answers/previous-submission?courseId=${courseId}&exerciseId=${exerciseId}&questionId=${question._id}&category=${category}`,
        {
          headers: {
